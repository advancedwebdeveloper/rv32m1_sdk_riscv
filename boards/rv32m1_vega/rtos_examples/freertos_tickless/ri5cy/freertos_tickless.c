...
#define BOARD_SW_GIC_PRIO 2
/* @brief FreeRTOS tickless timer configuration. */
#define BOARD_LPTMR_IRQ_HANDLER LPTMR2_IRQHandler /*!< Timer IRQ handler. */
#define TICKLESS_LPTMR_BASE_PTR LPTMR2            /*!< Tickless timer base address. */
#define TICKLESS_LPTMR_IRQn LPTMR2_IRQn           /*!< Tickless timer IRQ number. */
...
void APP_InitSW(void)
{
    NVIC_SetPriority(TICKLESS_LPTMR_IRQn, 1);
    NVIC_SetPriority(BOARD_SW_IRQ, 2);
...
/* Define the init structure for the input switch pin */
    ...
    LPTMR_Init(TICKLESS_LPTMR_BASE_PTR, &lptmr_config);
    ...
    INTMUX_Init(INTMUX0);
    INTMUX_EnableInterrupt(INTMUX0, 0, BOARD_SW_IRQ);
