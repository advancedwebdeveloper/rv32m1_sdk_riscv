...
#include "fsl_trng.h"
    ...
    trngConfig.frequencyCountLimit.maximum = 0x3fffff;
...
static int OpenNitroxDevice(int dma_mode,int dev_id)
{
   ...
   return CspInitialize(dma_mode, dev_id);
    ...
    int main(int argc, char** argv)
    {
        ...
        {
            selftest_printf("Selftest finished\r\n");
            while (1)
            {
            }
        }
...
{
    SystemSetupSystick(TICK_HZ, 7); /* 1 ms period, interrupt priority 7 */
    return 0;
}
