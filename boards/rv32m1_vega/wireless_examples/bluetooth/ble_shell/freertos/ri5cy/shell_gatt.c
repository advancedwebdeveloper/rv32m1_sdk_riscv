...
extern bool_t gTroughputInProgress;
...
*************************************************************************************
************************************************************************************/
extern void ShellThr_ProcessNotification(uint32_t len);
extern void ShellThr_MtuExchangeCallback(void);
...
)
{
  if(gTroughputInProgress)  
  {
    ShellThr_ProcessNotification(valueLength);
  }
  else
  {
