...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c), 24, "RV32M1_BLE_THROUGHPUT_DEMO")
...
PRIMARY_SERVICE_UUID128(service_throughput, uuid_service_throughput)
    CHARACTERISTIC_UUID128(char_throughput_tream, uuid_throughput_stream, (gGattCharPropWriteWithoutRsp_c))
    ...
    CHARACTERISTIC_UUID128(char_throughput_status, uuid_throughput_status, (gGattCharPropNotify_c))
        VALUE_UUID128_VARLEN(value_throughput_status, uuid_throughput_status, (gPermissionNone_c), 2, 0x00, 0x00)
        DESCRIPTOR(throughput_status, gBleSig_CharPresFormatDescriptor_d, (gPermissionFlagReadable_c), 7, 0x0E, 0xFE, 0x2F, 0x27, 0x00, 0x00, 0x00)
        CCCD(cccd_throughput_status)
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 20, "Throughput test Demo")
